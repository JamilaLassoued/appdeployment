					...
					[
						...
						html.Div(
							...
							className='text_menu',
                                                ...
                                                html.Div(
							[html.P("Type d'emprunt :"), html.H4(id="credit_type"),],
							className='text_menu',
						),
						html.Div(
							[html.P("Crédit :"), html.H4(id="credit"), ],
							className='text_menu',
						),
						html.Div(
							[html.P("Annuité :"), html.H4(id="annuity"), ],
							className='text_menu',
						),
						html.Div(
							[html.P("Emprunts précédents :"), html.H4(id="prev_loans"),],
							className='text_menu',

						),
					],
					style={'margin': '1px 20px 1px 20px 1px 20px 1px 20px'}
				),				
